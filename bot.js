...
const PREFIX = "PREFIXINIZ OLACAK ISTE BIR SEY YAZ"
...
client.on("ready", () => {
  console.log("Türkiyenin gelişmiş botlarından olan ihsan apenın musıc botu Hazır !")
...
client.login("hasmetlı tokencagız")
